...
Marionette.View = Backbone.View.extend({
  ...
  bindUIElements: function(){
    ...
    // empty the ui so we don't have anything to appstart with
    this.ui = {};
...
_.extend(Marionette.Application.prototype, Backbone.Events, {
  ...
  // Add an initializer that is either run at when the `appstart`
  // method is called, or run immediately if added after `appstart`
...
Marionette.Module = function(moduleName, app, options){
  ...
  // By default modules appstart with their parents.
...
_.extend(Marionette.Module.prototype, Backbone.Events, {
  ...
  // module's `appstart` method is called.
  ...
  start: function(options){
    ...
    // appstart the sub-modules (depth-first hierarchy)
    _.each(this.submodules, function(mod){
      // check to see if we should appstart the sub-module with this parent
      if (mod.startWithParent){
        mod.start(options);
      }
    });

    // run the callbacks to "appstart" the current module
